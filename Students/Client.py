...
class Client:
    ...
    def __init__(self, master, serveraddr, serverport, rtpport, filename):
        ...
        # variables:
        # ------------------
        self.statDataRate = 0.0
        self.statTotalBytes = 0
        self.statStartTime = 0.0
        self.statTotalPlayTime = 0.0
        self.statFractionLost = 0.0
        self.statCumLost = 0
        self.statExpRtpNb = 0
        self.statHighSeqNb = 0

    # THIS GUI IS JUST FOR REFERENCE ONLY, STUDENTS HAVE TO CREATE THEIR OWN GUI
    def createWidgets(self):
        """Build GUI."""
        # namevid
        name = Label(self.master, text="Name of video").grid(row=5, column=0)
    ...
    def describeMovie(self):
        ...
        e1 = Label(self.master, text=self.fileName + " is being shown, total time: " + str(self.statTotalPlayTime) + ",remaining time: " + str(10 - self.statTotalPlayTime)).grid(row=5, column=3)
